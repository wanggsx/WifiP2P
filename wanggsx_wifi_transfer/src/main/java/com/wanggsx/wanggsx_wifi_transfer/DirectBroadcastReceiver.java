...
public class DirectBroadcastReceiver extends BroadcastReceiver {
    ...
    private OnWifiChangedListener mDirectActionListener;

    public DirectBroadcastReceiver(WifiP2pManager wifiP2pManager, WifiP2pManager.Channel channel, OnWifiChangedListener directActionListener) {
